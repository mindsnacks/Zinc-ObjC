...
static const float kContentBundleFlushLimitInMegabytes = -1.f;
...
- (void)purgeBundlesWithIDS:(NSSet<NSString *> *)bundleIDs bundleURLs:(NSSet<NSURL *> *)bundleURLs {
    @synchronized(self.index) {
        for (NSString *bundleID in bundleIDs) {
            [self postNotification:ZincRepoBundleWillDeleteNotification bundleID:bundleID];
