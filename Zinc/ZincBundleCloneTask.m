...
- (void) setUp
{
    ...
    [self addEvent:[ZincBundleCloneBeginEvent bundleCloneBeginEventForBundleResource:self.resource source:ZINC_EVENT_SRC_OBJECT() context:self.bundleId]];
}
...
- (void) completeWithSuccess:(BOOL)success
{
    ...
    [self addEvent:[ZincBundleCloneCompleteEvent bundleCloneCompleteEventForBundleResource:self.resource source:ZINC_EVENT_SRC_OBJECT() context:self.bundleId success:success]];
